...
- (id)initWithStatusModel:(StatusModel *)statusModel
    ...
    if (self) {
        ...
        avatarStorage.contents = [UIImage imageWithData:statusModel.avatar];
...
//        nameTextStorage.font = [UIFont systemFontOfSize:15];
        ...
        if (contentTextStorage.isTruncation) {
            ...
            openStorage.font = [UIFont systemFontOfSize:15];;
        ...
        if ([statusModel.type isEqualToString:MESSAGE_TYPE_IMAGE]) {
            ...
            if (imageCount == 1) {
                ...
                UIImage *img = [UIImage imageWithData:[statusModel.imgs objectAtIndex:0]];
                CGSize imgSize = img.size;
                CGSize ruleSize = CGSizeMake(180, 180);
                ...
                CGRect imageRect = CGRectMake(nameTextStorage.left,
                                              contentBottom + imageSpace + (row * (imageWidth + imageSpace)) + 3,
                                              imgSize.width,
                                              imgSize.height);
...
//                NSString* URLString = [statusModel.imgs objectAtIndex:0];
                UIImage *image = [UIImage imageWithData:[statusModel.imgs objectAtIndex:0]];
                imageStorage.contents = image;
                [imageStorageArray addObject:imageStorage];
            }else if (imageCount == 4){
                for (NSInteger i = 0; i < imageCount; i ++) {
                    CGRect imageRect = CGRectMake(nameTextStorage.left + (column * (imageWidth + imageSpace)),
                                                  contentBottom + imageSpace + (row * (imageWidth + imageSpace)),
                                                  imageWidth,
                                                  imageWidth);
                    ...
                    UIImage *image = [UIImage imageWithData:[statusModel.imgs objectAtIndex:i]];
                    imageStorage.contents = image;
                    [imageStorageArray addObject:imageStorage];
                    column = column + 1;
                    if (column > 1) {
...
//                    NSString* URLString = [statusModel.imgs objectAtIndex:i];
        ...
        if (![statusModel.type isEqualToString:MESSAGE_TYPE_VIDEO]) {
            menuPosition = CGRectMake(SCREEN_WIDTH - 44.0f,
        ...
        if (statusModel.likeList.count != 0) {
            likeImageSotrage.contents = [UIImage imageNamed:@"Like.png"];
            likeImageSotrage.frame = CGRectMake(rect.origin.x + 10.0f,
                                                rect.origin.y + 8.0f + offsetY,
                                                14.0f,
                                                14.0f);
            ...
            NSString *space = @"     ";
            [mutableString appendString:space];
            rangeOffset += 5;
            ...
            likeTextStorage.font = [UIFont boldSystemFontOfSize:14];;
            likeTextStorage.frame = CGRectMake(likeImageSotrage.left,
                                               rect.origin.y + 7.0f,
                                               SCREEN_WIDTH - 85.0f,
                                               CGFLOAT_MAX);
        ...
        if (statusModel.commentList.count != 0 && statusModel.commentList != nil) {
            ...
            for (NSDictionary* commentDict in statusModel.commentList) {
                ...
                if (to.length != 0) {
                    ...
                    commentTextStorage.font = [UIFont systemFontOfSize:14];;
                    ...
                    offsetY += commentTextStorage.height + 3;
                } else {
        ...
        //有回复信息状态的聊天气泡
        if (self.statusModel.commentList.count != 0) {
            commentBgPosition = CGRectMake(60.0f,
                                           dateTextStorage.bottom,
                                           SCREEN_WIDTH - 70,
                                           offsetY + 20.0f);
...
//        nameTextStorage.font = [UIFont systemFontOfSize:15];
        ...
        closeStorage.font = [UIFont systemFontOfSize:15];;
        ...
        //网页链接类型
            ...
            LWTextStorage* detailTextStorage = [[LWTextStorage alloc] init];
            detailTextStorage.text = statusModel.detail;
            detailTextStorage.font = [UIFont systemFontOfSize:12];;
            detailTextStorage.textColor = RGB(40, 40, 40, 1);
            detailTextStorage.frame = CGRectMake(imageStorage.right + 10.0f,
                                                 contentBottom + 10.0f,
                                                 SCREEN_WIDTH - 150.0f,
        ...
        if (statusModel.likeList.count != 0) {
            ...
            likeTextStorage.text = mutableString;
            likeTextStorage.font = [UIFont systemFontOfSize:16];
        ...
        if (statusModel.commentList.count != 0 &&
            ...
            for (NSDictionary* commentDict in statusModel.commentList) {
                ...
                if (to.length != 0) {
                    ...
                    LWTextStorage* commentTextStorage = [[LWTextStorage alloc] init];
                    commentTextStorage.text = commentString;
                    commentTextStorage.font = [UIFont systemFontOfSize:16];;
                    commentTextStorage.textColor = RGB(40, 40, 40, 1);
                    commentTextStorage.frame = CGRectMake(rect.origin.x + 10.0f,
                                                          rect.origin.y + 10.0f + offsetY,
                                                          SCREEN_WIDTH - 95.0f,
