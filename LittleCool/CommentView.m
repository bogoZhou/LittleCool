...
- (UIButton *)emojiButton {
    ...
    [_emojiButton addTarget:self action:@selector(changeUserByEmojiButtonClick:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)changeUserByEmojiButtonClick:(UIButton *)button{
//    kAlert(@"点击更换头像");
    [[NSNotificationCenter defaultCenter] postNotificationName:@"chooseUser" object:nil];
}
