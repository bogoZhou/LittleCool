...
#define  OUTPUT_DECODEPATH  [NSString stringWithFormat:@"%@",DOCMENT]           //解码音频存储位置
#define  OUTPUT_SOUNDTOUCHPATH  [NSString stringWithFormat:@"%@",DOCMENT]   //变声过的音频存储位置
#define  OUTPUT_ENCODETMPPATH  [NSString stringWithFormat:@"%@",DOCMENT]    //编码音频临时存储位置
#define  OUTPUT_ENCODEPATH  [NSString stringWithFormat:@"%@",DOCMENT]           //编码音频存储位置
