...
//    [self.frontView insertSubview:self.bubbleLabel atIndex:0];
    ...
    self.bubbleImageView.frame = CGRectMake(0, 0, self.frontView.bounds.size.width, self.frontView.bounds.size.height);
    self.bubbleImageView.userInteractionEnabled = YES;
    [self.frontView insertSubview:self.bubbleImageView atIndex:0];
    
    self.bubbleButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, self.frontView.bounds.size.width, self.frontView.bounds.size.height)];
    self.bubbleButton.backgroundColor = kClearColor;
    [self.frontView insertSubview:self.bubbleButton aboveSubview:self.bubbleImageView];
