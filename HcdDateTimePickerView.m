...
- (void)showHcdDateTimePicker
{
    ...
    [UIView animateWithDuration:0.3f delay:0 usingSpringWithDamping:0.8f initialSpringVelocity:0 options:UIViewAnimationOptionLayoutSubviews animations:^{
        ...
        [timeBroadcastView setFrame:CGRectMake(0, kScreen_Height - kDatePickerHeight - 64, kScreen_Width, kDatePickerHeight)];
        ...
        if (btns.tag == kOKBtnTag) {
            ...
            switch (self.datePickerMode) {
                ...
                case DatePickerDateHourMinuteMode:
                    ...
                    dateTimeStr = [NSString stringWithFormat:@"%ld-%02ld-%02ld %02ld:%02ld:%02ld",(long)self.curYear,(long)self.curMonth,(long)self.curDay,(long)self.curHour,(long)self.curMin,(long)x];
                    break;
                default:
